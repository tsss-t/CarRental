...
namespace WFpart.CheckoutService {
    ...
    public interface ICheckout {
        ...
        bool AddCheckout(WFpart.CheckoutService.Car_Checkout Checkout);
        ...
        bool UpdateCheckout(WFpart.CheckoutService.Car_Checkout TempCheckout);
        ...
        WFpart.CheckoutService.Car_Checkout SelectCheckout_ID(int CheckoutID);
        ...
        WFpart.CheckoutService.Car_Checkout[] SelectAllCheckouts();
        ...
        WFpart.CheckoutService.Car_Checkout[] SelectCheckoutDIY_Func(System.Func<WFpart.CheckoutService.Car_Checkout, bool> where);
        ...
        WFpart.CheckoutService.Car_Checkout[] SelectCheckoutDIY_Field(System.Func<WFpart.CheckoutService.Car_Checkout, bool> where, System.Func<WFpart.CheckoutService.Car_Checkout, WFpart.CheckoutService.Car_Checkout> select);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ICheckoutChannel : WFpart.CheckoutService.ICheckout, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CheckoutClient : System.ServiceModel.ClientBase<WFpart.CheckoutService.ICheckout>, WFpart.CheckoutService.ICheckout {
        ...
        public bool AddCheckout(WFpart.CheckoutService.Car_Checkout Checkout) {
        ...
        public bool UpdateCheckout(WFpart.CheckoutService.Car_Checkout TempCheckout) {
            return base.Channel.UpdateCheckout(TempCheckout);
        }
        
        public WFpart.CheckoutService.Car_Checkout SelectCheckout_ID(int CheckoutID) {
            return base.Channel.SelectCheckout_ID(CheckoutID);
        }
        
        public WFpart.CheckoutService.Car_Checkout[] SelectAllCheckouts() {
            return base.Channel.SelectAllCheckouts();
        }
        
        public WFpart.CheckoutService.Car_Checkout[] SelectCheckoutDIY_Func(System.Func<WFpart.CheckoutService.Car_Checkout, bool> where) {
            return base.Channel.SelectCheckoutDIY_Func(where);
        }
        
        public WFpart.CheckoutService.Car_Checkout[] SelectCheckoutDIY_Field(System.Func<WFpart.CheckoutService.Car_Checkout, bool> where, System.Func<WFpart.CheckoutService.Car_Checkout, WFpart.CheckoutService.Car_Checkout> select) {
